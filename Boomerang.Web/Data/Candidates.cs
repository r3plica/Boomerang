...
namespace Boomerang.Web.Data
{
    class Candidates
    {
        ...
        public static Candidate Parse(SqlDataReader dr)
        {
            ...
            Candidate.Telephone = Convert.ToString(dr["Telephone"]);
            Candidate.Mobile = Convert.ToString(dr["Mobile"]);
            Candidate.Email = Convert.ToString(dr["Email"]);
            ...
            Candidate.NiNumber = Convert.ToString(dr["NiNumber"]);
            ...
            Candidate.UserId = Convert.ToString(dr["UserId"]);
            Candidate.UserName = Convert.ToString(dr["UserName"]);
